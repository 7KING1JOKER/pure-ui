...
<script setup>
import { PureCard, PureButton } from '@pure-ui/core'
</script>
...
<div style="display: flex; gap: 20px; flex-wrap: wrap; margin: 16px 0;">
  <pure-card type="col" :shadow="true" :bordered="true" style="width: 300px;">
    <template #header>
      <h3>Header</h3>
    </template>
    <template #default>
      <p>这是卡片的主要body内容区域。可以放置任何内容，包括文本、图片、表单等。</p>
    </template>
    <template #footer>
      <pure-button type="primary" size="small">Footer</pure-button>
    </template>
  </pure-card>
...
<div style="width: 100%; margin: 16px 0;">
  <pure-card type="row" :shadow="true" :bordered="true">
    <template #left>
      <div class="card-left-content" style="padding: 20px; border-right: 1px solid #e5e5e5;">
        <h4>左侧</h4>
        <p>侧边栏内容</p>
      </div>
    </template>
    <template #default>
      <div class="card-main-content" style="padding: 20px; flex: 1;">
        <h4>主内容</h4>
        <p>这是卡片的主要内容区域。</p>
    ...
    <template #right>
      <div class="card-right-content" style="padding: 20px; border-left: 1px solid #e5e5e5;">
        <h4>右侧</h4>
        <p>侧边栏内容</p>
      </div>
    </template>
...
<div style="display: flex; gap: 20px; flex-wrap: wrap; margin: 16px 0;">
  ...
  <pure-card type="col" :shadow="false" :bordered="false" style="width: 300px;">
    <template #header>
      <h3>无阴影 + 无边框</h3>
    </template>
    <template #default>
  ...
  <pure-card type="col" :shadow="true" :bordered="false" style="width: 300px;">
    <template #header>
      <h3>仅阴影</h3>
    </template>
    <template #default>
